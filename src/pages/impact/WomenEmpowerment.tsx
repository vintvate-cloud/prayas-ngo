              ...
              >
                ...
                <div className={`lg:col-span-6 space-y-5 text-center ${isEven ? 'lg:order-2' : 'lg:order-1'}`}>
                  ...
                  <div className="pt-2">
                    <Link
                      to="/donate"
                      className="inline-flex items-center gap-2 bg-[#DC2626] hover:bg-[#881337] text-white font-semibold px-7 py-3 rounded-full shadow-md transition-all text-sm group"
                    >
      ...
      <section className="py-20 sm:py-28 bg-[#FFF1F2]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#881337] tracking-tight mb-4">
              Impacting lives <span className="text-[#DC2626]">across communities</span>
            </h2>
          </motion.div>
            ...
            {[
              {
                icon: ShoppingBag,
                title: 'Sabji Wali Didi',
                desc: 'Micro-credit and financial literacy for vendors.'
              },
              {
                icon: Scissors,
                title: 'Sewing Centres',
                desc: 'Vocational tailoring and garment making.'
              },
              {
                icon: Users,
                title: 'SHGs',
                desc: 'Self-help group savings and bank linkages.'
              },
              {
                icon: Home,
                title: 'Grah Udyog',
                desc: 'Home-based sustainable micro-enterprises.'
              }
            ].map((item, i) => (
              <motion.div
                key={i}
                ...
                transition={{ duration: 0.5, delay: i * 0.1 }}
                viewport={{ once: true }}
                className="bg-white p-6 rounded-2xl border border-[#DC2626]/20 hover:shadow-lg transition-all text-center"
              >
                <div className="w-12 h-12 mx-auto rounded-xl bg-[#FFF1F2] flex items-center justify-center text-[#DC2626] mb-4">
                  <item.icon className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold text-[#881337] mb-2">{item.title}</h3>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="mt-12 bg-[#881337] rounded-3xl p-8 sm:p-12 text-white shadow-xl"
          >
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                <h3 className="text-xl sm:text-2xl font-bold mb-1">Working across 6 states</h3>
                <p className="text-white/70 text-sm">Empowering thousands of women each year</p>
              </div>
              <div className="flex flex-wrap justify-center gap-2">
                {['Uttar Pradesh', 'Bihar', 'Rajasthan', 'Madhya Pradesh', 'Odisha', 'Maharashtra'].map((state) => (
